...
- WordPress + Automattic standards. Tabs, Yoda conditions, strict comparisons (`===` / `!==`), `array()` not `[]`. PHPCS enforces all four, across `includes/`, `tests/` and the root PHP files. Tests are held to the same FORMATTING rules as the plugin; sniffs that encode rules about shipping a plugin — global prefixes, output escaping, `WP_Filesystem` over `file_get_contents` — are scoped to production only, each with its reason in `phpcs.xml.dist`.
...
| `includes/ai-storefront/class-wc-ai-storefront-meta-tags.php` | YOAST-COEXISTENCE.md, ARCHITECTURE.md, HOOKS.md, SEO-EMISSION-MATRIX.md |
| `includes/ai-storefront/class-wc-ai-storefront-content-meta-tags.php` | YOAST-COEXISTENCE.md, ARCHITECTURE.md, HOOKS.md |
| `includes/ai-storefront/class-wc-ai-storefront-meta-text.php` | ARCHITECTURE.md |
| `includes/ai-storefront/class-wc-ai-storefront-meta-image.php` | ARCHITECTURE.md |
...
| `includes/ai-storefront/class-wc-ai-storefront-og-strategy-yoast.php` | YOAST-COEXISTENCE.md |
| `includes/ai-storefront/class-wc-ai-storefront-og-strategy-aioseo.php` | YOAST-COEXISTENCE.md |
| `includes/ai-storefront/class-wc-ai-storefront-og-strategy-rankmath.php` | YOAST-COEXISTENCE.md |
| `includes/ai-storefront/class-wc-ai-storefront-og-commerce-facts.php` | YOAST-COEXISTENCE.md, ARCHITECTURE.md |
| `includes/ai-storefront/class-wc-ai-storefront-yoast-og-presenter.php` | YOAST-COEXISTENCE.md |
