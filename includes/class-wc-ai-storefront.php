...
class WC_AI_Storefront {
	...
	public function render_admin_page() {
		...
		echo '<header style="display:flex;align-items:flex-start;gap:8px;padding:12px 0 12px;background:#fff;margin-bottom:4px;">';
		echo '<svg width="20" height="20" viewBox="0 0 375 375" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" style="flex-shrink:0;margin-top:1px;"><path fill-rule="evenodd" clip-rule="evenodd" d="M187.5 375C291.053 375 375 291.053 375 187.5C375 83.9466 291.053 0 187.5 0C83.9466 0 0 83.9466 0 187.5C0 291.053 83.9466 375 187.5 375ZM165.409 242.53C155.31 261.493 141.913 269.737 125.217 269.737C104.4 269.737 90.1786 257.164 90.1786 235.935V160.704H74.308C60.0863 160.704 52.2541 153.49 52.2541 140.917C52.2541 128.345 59.6741 121.543 74.308 121.543H113.057C132.019 121.543 139.851 129.581 139.851 148.544V207.491L173.448 141.742C181.074 126.902 190.967 121.543 203.334 121.543C218.998 121.543 227.449 130.2 227.449 147.925V207.491L263.106 140.505C270.938 125.871 279.595 121.543 292.992 121.543C317.932 121.543 325.97 135.971 314.634 155.139L262.9 242.53C251.152 262.523 238.991 269.737 222.502 269.737C201.479 269.737 187.875 257.164 187.875 236.141V200.484L165.409 242.53Z" fill="#873EFF"/></svg>';
		echo '<div>';
		echo '<h2 style="margin:0;padding:0;font-size:15px;font-weight:500;color:#1d2327;line-height:1.2;">' . esc_html__( 'AI Storefront', 'woocommerce-ai-storefront' ) . '</h2>';
		echo '<p style="margin:0;padding:0;font-size:12px;color:#646970;line-height:1.4;">' . esc_html__( 'Make your store ready for AI shopping assistants', 'woocommerce-ai-storefront' ) . '</p>';
		echo '</div>';
		echo '</header>';
