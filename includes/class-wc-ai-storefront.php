...
class WC_AI_Storefront {
	...
	public function render_admin_page() {
		...
		echo '<p style="margin:2px 0 0;padding:0;font-size:12px;color:#646970;line-height:1.4;">' . esc_html__( 'Make your store ready for AI shopping assistants', 'woocommerce-ai-storefront' ) . '</p>';
		echo '</div>';
		echo '</div>';
		echo '</header>';
