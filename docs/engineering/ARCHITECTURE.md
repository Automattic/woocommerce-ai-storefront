...
| `class-wc-ai-storefront-product-meta-box.php` | Adds the `Final sale` checkbox to the product editor's Inventory tab. Read by `WC_AI_Storefront_JsonLd` to override the store-wide return policy on a per-product basis. |
