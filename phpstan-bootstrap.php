...
if ( ! defined( 'WC_AI_SYNDICATION_VERSION' ) ) {
	define( 'WC_AI_SYNDICATION_VERSION', '0.0.0' );
}
...
if ( ! defined( 'WC_AI_SYNDICATION_PLUGIN_PATH' ) ) {
	define( 'WC_AI_SYNDICATION_PLUGIN_PATH', __DIR__ );
}
if ( ! defined( 'WC_AI_SYNDICATION_PLUGIN_URL' ) ) {
	define( 'WC_AI_SYNDICATION_PLUGIN_URL', 'https://example.com' );
}
