...
- **Searching by category returned nothing on stores with extensions installed (#660).**
  ...
  - Categories, tags, brands and attributes like size and colour are all affected, and which ones break depends on what else you have installed. Filtering by category from the API kept working throughout, which is why this was easy to miss.
