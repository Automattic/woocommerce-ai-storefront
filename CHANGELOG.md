...
- **`JsonLdTest.php`** (PR #335) — 10 new unit tests covering empty-input no-op for both properties, `@id` shape for both, syndication-exclusion filtering for both, deleted-product skip, existing-markup preservation for both, and the 10-entry hard cap.
